...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "./logs/shapes20190414T1423/mask_rcnn_shapes_0134.h5")
# Download COCO trained weights from Releases if needed
if not os.path.exists(COCO_MODEL_PATH):
    utils.download_trained_weights(COCO_MODEL_PATH)

# Directory of images to run detection on
IMAGE_DIR = os.path.join(ROOT_DIR, "./datasets/rgb")
#IMAGE_DIR = os.path.join(ROOT_DIR, "./test_icdar")
...
#class_names = ['BG', 'character','colunm','box']
class_names = ['BG','text']
